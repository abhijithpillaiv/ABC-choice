...
function signup() {
    ...
    const submitHandler = (event) => {
        ...
        if (validEmail.test(Email) === true && Password === rePassword && Terms === false) {
            axios.post('/api/signup', { name: Name, email: Email, password: Password,phone:Phone }).then((response) => {
                            ...
                            <div className="signup-form">
                                ...
                                <form onSubmit={submitHandler} className="register-form" id="register-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <label for="agree-term" onClick={() => setTerms(!Terms)} className="label-agree-term"><span><span></span></span>I agree all statements in  <Link className="term-service">Terms of service</Link></label>
