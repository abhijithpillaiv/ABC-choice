...
function Edititem({data}) {
    ...
    const [serves, setserves] = useState(data.serves);
                    ...
                    <form onSubmit={submitHandler} className="new-added-form">
                        <div className="row">
                            <div className="col-xl-12 col-lg-12 col-12 form-group">
                                <label>Title *</label>
                                <input value={title}  style={{fontWeight:'bold',fontSize:'20px'}} required name="title"type="text" onChange={(e)=>settitle(e.target.value)} className="form-control"/>
                            </div>
                           
                            <div className="col-xl-6 col-lg-6 col-12 form-group">
                                <label>Ingredients</label>
                                <textarea style={{fontSize:'15px',height:'250px'}} value={ingredients}  onChange={(e)=>setingredients(e.target.value)} name="ingredients"  placeholder="" className="form-control"/>
                            </div>
                           
                            <div className="col-xl-6 col-lg-6 col-12 form-group">
                                <label>Preparation</label>
                                <textarea style={{fontSize:'15px',height:'250px'}} value={preparation} onChange={(e)=>setpreparation(e.target.value)} name="preparation"  placeholder="" className="form-control"/>
                            </div> 

                            <div className="col-xl-6 col-lg-6 col-12 form-group">
                                <label>Serves</label>
                                <input  type="text" value={serves}  onChange={(e)=>setserves(e.target.value)} name="serves"  placeholder="" className="form-control"/>
                            </div> 
                            ...
                            <div className="col-12 form-group mg-t-8">
                                ...
                                <button onClick={()=>{setPreview(null); history.push('/write')}} type="reset" className="btn-fill-lg bg-blue-dark btn-hover-yellow">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
